...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public final int divideBy10() {
        ...
        int lastDigit = Integer.parseInt(this.rep.substring(lastIndex));

        // Get substring without last digit
        this.rep = this.rep.substring(0, lastIndex - 1);
        return lastDigit;
    }
